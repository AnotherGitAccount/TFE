...
# ACDS 16.0 211 win32 2021.04.25.01:27:06
# ----------------------------------------
...
# ----------------------------------------
# If graphic_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "graphic_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/graphic_pll.vo"
}
