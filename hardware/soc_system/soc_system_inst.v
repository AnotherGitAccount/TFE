	soc_system u0 (
		...
		.im_avbus_acknowledge                  (<connected-to-im_avbus_acknowledge>),                  //                  im_avbus.acknowledge
		.im_avbus_irq                          (<connected-to-im_avbus_irq>),                          //                          .irq
		.im_avbus_address                      (<connected-to-im_avbus_address>),                      //                          .address
		.im_avbus_bus_enable                   (<connected-to-im_avbus_bus_enable>),                   //                          .bus_enable
		.im_avbus_byte_enable                  (<connected-to-im_avbus_byte_enable>),                  //                          .byte_enable
		.im_avbus_rw                           (<connected-to-im_avbus_rw>),                           //                          .rw
		.im_avbus_write_data                   (<connected-to-im_avbus_write_data>),                   //                          .write_data
		.im_avbus_read_data                    (<connected-to-im_avbus_read_data>),                    //                          .read_data
