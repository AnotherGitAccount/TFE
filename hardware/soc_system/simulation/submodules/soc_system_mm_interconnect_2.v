...
module soc_system_mm_interconnect_2 (
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> ILC_avalon_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire    [4:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire    [4:0] router_001_src_channel;                                                     // router_001:src_channel -> fpga_only_master_master_limiter:cmd_sink_channel
	...
	wire    [4:0] fpga_only_master_master_limiter_cmd_src_channel;                            // fpga_only_master_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> fpga_only_master_master_limiter:rsp_sink_channel
	...
	wire    [4:0] fpga_only_master_master_limiter_cmd_valid_data;                             // fpga_only_master_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
