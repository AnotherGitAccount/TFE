...
is called ram\_32768 in the project, its ports are shown in Figure \ref{fig:components/im_in}.
...
the ram\_32768 to access the memory. Note that the notation cpu\_address[16:2] in Figure \ref{fig:components/im_in}
means that bits 2 to 16 of cpu\_address are selected. The other bits are unused.
